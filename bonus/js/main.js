...
$(document).ready(function() {
  ...
  // controllo il carousel tramite tastiera
  // aggiunto un evento che "ascolta" se premo dei tasti sulla tastiera
  $(document).keydown(function(event) {
    // se il tasto premuto è la freccia destra eseguo la funzione "nextImg"
    if(event.key == "ArrowRight") {
      nextImg();
    }
    // se il tasto premuto è la freccia sinistra eseguo la funzione "prevImg"
